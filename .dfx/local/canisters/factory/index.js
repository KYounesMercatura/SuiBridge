 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./factory.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the factory canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./factory.did.js")._SERVICE>}
 */
export const factory = createActor(canisterId);
